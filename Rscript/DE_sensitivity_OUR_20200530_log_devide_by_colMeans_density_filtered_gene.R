...
load('../10X_DE_sensitivity/CD14_10_cells_1_ExprM.RData')
...
for(num in DE.range){
  ...
  write.csv(auc.ave, file='auc_10.csv')
}
...
save(auc.our, file='./results/AUC_res_OUR_20200530_log_devide_by_colMeans_density_filtered_gene.RData')
